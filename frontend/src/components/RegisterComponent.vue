...
const register = async () => {
  ...
  if (newUser) {
    router.push('/auth/login') // redirect newly registered user to login page after successful registration.
  }
}
</script>
          ...
          <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
            ...
            <div>
              ...
              <div class="flex -mx-3">
                <div class="w-full px-3 mb-5">
                  <button
                    class="cursor-pointer block w-full max-w-xs mx-auto bg-indigo-500 hover:bg-indigo-700 focus:bg-indigo-700 text-white rounded-lg px-3 py-3 font-semibold"
                    type="button"
                    @click="register"
                  >
                    REGISTER NOW
